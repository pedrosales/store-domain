...
namespace Store.Tests.Domain
{
    ...
    public class OrderTests
    {
        ...
        private readonly Customer _customer = new Customer("Pedro ivo", "pedroivossantos@gmail.com");
        ...
        {
            var order = new Order(_customer, 0, null);
            //order.Itens.Add(new OrderItem(_product, 1));
        ...
        public void Dado_um_novo_item_sem_produto_o_mesmo_nao_deve_ser_adicionado()
        {
            ...
            Assert.AreEqual(0, order.Itens.Count);
        }
        ...
        {
            var discountExpirado = new Discount(10, DateTime.Now.AddDays(-5));
            var order = new Order(_customer, 0, discountExpirado);
